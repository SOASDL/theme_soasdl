...
$THEME->javascripts_footer = array(
    'jquery-1.11.0.min','soasdl','bootstrap-tab','bootstrap-collapse','bootstrap-modal','jquery.dataTables.min','jquery-ui.min', 'chosen.jquery.min', 'jstree.min', 'chosen.ajaxaddition.jquery', 'jquery.nestable'
