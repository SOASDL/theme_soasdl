...
<div id="page" class="container-fluid" style="position: relative; top: 40px">
    ...
    <div id="page-content" class="row-fluid">
        <section id="region-main" class="span9<?php if ($left) { echo ' pull-right'; } ?>">
            ...
            //var_dump($filename);
            if($filename == '/user/edit.php'){
                echo '<p style="color: red"><strong>On this page you can update some elements of your profile including your profile picture. To change your name, despatch address or permanent address or email, <a target="_blank" href="https://studentsonline.soas.ac.uk/WebSite/OnlineServices/default.aspx">click here</a> to go to the Student Records Online Service</p>';
            }
