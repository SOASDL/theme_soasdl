...
This document describes how to copy and customise the soasdl (bootstrapbase) theme so that
...
From your Moodle theme directory right click on soasdl and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of soasdl.
...
underscores. For the purpose of this tutorial we will call the theme 'soasdltheme'.

On opening 'soasdltheme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case soasdl. So using the above list as
a guide, search through and change all the instances of the theme name
'soasdl' to 'soasdltheme'. This includes the filename of the lang/en/theme_soasdl.php.
You need to change this to 'theme_soasdltheme.php'.
...
and then click on (soasdltheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the soasdl theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > soasdl
